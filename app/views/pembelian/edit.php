                ...
                <form action=" <?= ROUTE_URL; ?>/pembelian/edit_submit" method="post">
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        ...
                        <label class=" block mt-4 text-sm hidden">
                            ...
                            <input name="idPengguna" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="<?= $data['pembelian']['idPengguna']; ?>" />
                        </label>

                        <label class=" block mt-4 text-sm hidden">
                            <span class="text-gray-700 dark:text-gray-400"> Id Barang </span>
                            <input name="idBarang" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="<?= $data['pembelian']['idBarang']; ?>" />
                        </label>

                        <label class=" block mt-4 text-sm hidden">
                            <span class="text-gray-700 dark:text-gray-400"> Id Supplier </span>
                            <input name="idSupplier" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="<?= $data['pembelian']['idSupplier']; ?>" />
                        </label>
