    ...
    <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full pb-16 overflow-y-auto">
            <div class="container grid px-6 mx-auto">
                ...
                <!-- Button -->
                <!-- <div class="px-6 my-6">
                    <a href="<?= ROUTE_URL ?>/paketPenjualan/create" class="items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                        Add Paket Penjualan
                        ...
                        <table class="w-full whitespace-no-wrap">
                            <thead>
                                <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                    ...
                                    <th class="px-4 py-3">Harga Paket</th>
                            ...
                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                <?php foreach ($data['paket_penjualan'] as $paket_penjualan) : ?>
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        <td class="px-4 py-3"><?= $paket_penjualan['nama_paket']; ?> </td>
                                        <td class="px-4 py-3"><?= $paket_penjualan['harga_paket']; ?> </td>
                                        <td class="px-4 py-3"><?= $paket_penjualan['namaBarang']; ?> </td>
                                        <td class="px-4 py-3"><?= $paket_penjualan['total_jumlah']; ?> </td>
                                        <td class="px-4 py-3"><?= $paket_penjualan['total_penjualan']; ?> </td>
