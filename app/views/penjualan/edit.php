                    ...
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <label class="block text-sm">
                            ...
                            <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                                <input type="number" name="jumlahPenjualan" id="jumlahPenjualan" class="block w-full pr-10 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input" value="<?= $data['penjualan']['jumlahPenjualan']; ?>" />
                        ...
                        <label class="block mt-4 text-sm">
                            ...
                            <input type="text" name="hargaJual" id="hargaJual" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value=" <?= $data['penjualan']['hargaJual']; ?>" />
                        </label>
                        ...
                        <label class=" block mt-4 text-sm hidden">
                            ...
                            <input name="idPengguna" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="<?= $data['penjualan']['idPengguna']; ?>" />
                        </label>

                        <label class=" block mt-4 text-sm hidden">
                            <span class="text-gray-700 dark:text-gray-400"> Id Barang </span>
                            <input name="idBarang" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="<?= $data['penjualan']['idBarang']; ?>" />
                        </label>

                        <label class=" block mt-4 text-sm hidden">
                            <span class="text-gray-700 dark:text-gray-400"> Id Pelanggan </span>
                            <input name="idPelanggan" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="<?= $data['penjualan']['idPelanggan']; ?>" />
                        </label>
