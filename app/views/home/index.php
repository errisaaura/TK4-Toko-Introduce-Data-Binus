                  ...
                  <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    <?php foreach ($data['analytic'] as $analytic) : ?>
                      <tr class="text-gray-700 dark:text-gray-400">
                        <td class="px-4 py-3"><?= $analytic['idBarang'] ?></td>
                        <td class="px-4 py-3 text-sm"><?= $analytic['namaBarang'] ?></td>
                        <td class="px-4 py-3 text-sm"><?= $analytic['TotalPenjualan'] ?></td>
                        <td class="px-4 py-3 text-sm"><?= $analytic['TotalPembelian'] ?></td>
                        <td class="px-4 py-3 text-sm"><?= $analytic['Selisih'] ?></td>
                        ...
                        <td class="px-4 py-3 text-xs">
                          ...
                          <?php elseif ($analytic["Status"] == "Rugi") : ?>
                              <span class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:bg-red-700 dark:text-red-100">
                                  Rugi
                              </span>
                          <?php elseif ($analytic["Status"] == "Balik Modal") : ?>
